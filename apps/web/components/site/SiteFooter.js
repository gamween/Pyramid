...
export function SiteFooter() {
  return (
    <footer className="mt-20 border-t museum-rule">
      <div className="flex w-full flex-col gap-8 px-4 py-8 md:flex-row md:items-end md:justify-between md:px-8 lg:px-10 xl:flex-nowrap">
        <p className="museum-copy max-w-2xl text-sm leading-6 xl:max-w-none xl:whitespace-nowrap">

...
export function LendingSection({ section }) {
  ...
  return (
    <section className="border-t museum-rule pb-16 pt-16 lg:min-h-[82svh] lg:grid lg:grid-cols-[minmax(0,0.98fr)_minmax(0,1.02fr)] lg:items-start lg:gap-16 lg:pt-20">
      <div className="max-w-3xl">
        ...
        <div className="mt-10 space-y-8 border-t border-black/15 pt-6">
          {pillars.map((pillar, index) => (
            <div key={pillar.label} className="flex max-w-3xl gap-4">
              <p className="font-ui text-[10px] uppercase tracking-[0.18em]">
      ...
      <figure className="relative mt-12 text-center lg:mt-0 lg:self-start">

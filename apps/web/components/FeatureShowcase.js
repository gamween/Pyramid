...
export default function FeatureShowcase({ features, onLaunch }) {
        ...
        return (
          ...
          >
            <div className="p-8 md:p-10 flex flex-col md:flex-row relative z-10 w-full justify-between items-start md:items-center">
              ...
              {/* Arrow when closed */}
              {!isActive && (
                <ArrowRight className="h-6 w-6 text-white/10 hidden md:block flex-shrink-0 transition-transform text-white/10" />
              )}
            </div>
              ...
              <div className="px-8 md:px-10 md:ml-[110px]">
                <div className="border-l border-white/10 pl-6">
                  ...
                  <button 
                    ...
                    className="flex items-center gap-3 text-white font-mono text-xs uppercase tracking-widest group-hover:gap-5 transition-all"
                  >
